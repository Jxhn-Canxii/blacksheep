        ...
        <div className="flex flex-col items-center text-center space-y-6 mb-8">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-white text-4xl font-black italic uppercase tracking-tighter">
              New <span className="text-emerald-500 underline decoration-emerald-500/10">Signal</span>
            </h1>
            <p className="text-neutral-500 text-sm font-medium opacity-80 max-w-[280px]">Initialize your link to the global neural grid.</p>
          </div>
        </div>
