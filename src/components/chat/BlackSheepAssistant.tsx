...
import { FEELINGS } from "@/libs/emotionConfig";
...
const BlackSheepAssistant = ({ vents }: BlackSheepAssistantProps) => {
  ...
  return (
    <div className="fixed bottom-6 right-4 z-[200] flex items-end gap-x-4 pointer-events-none">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 w-80 bg-neutral-900/80 backdrop-blur-2xl border border-emerald-500/30 rounded-[2.5rem] p-7 shadow-[0_0_50px_rgba(16,185,129,0.2)] relative pointer-events-auto"
          >
      ...
      <motion.button
        ...
        className="w-32 h-32 flex items-center justify-center transition-all relative group outline-none pointer-events-auto"
      >
